  ...
  return (
      ...
      <div class="hero-media">
        ...
        <div class="hero-content">
          <div class="hero-inner">
            <div class="badge best" style="margin-bottom:10px">Roastery • Thủ công</div>
    ...
    <section class="about section" id="about">
      <div class="container about-container">
        ...
        <section class="container reveal" id="sanpham" style="margin-top:34px">
          <div class="sec-head">
          ...
          <div class="container">
            ...
            <div class="blog-grid">
              <article class="post">
                ...
                <div class="body">
                  <span class="badge best" style="position:static;display:inline-block;margin-bottom:10px">Hướng dẫn</span>
                  <h3 class="h6">Cách pha cà phê ngon tại nhà</h3>
                  <p class="muted">Bí quyết pour-over & espresso, dụng cụ nên dùng và tỷ lệ vàng…</p>
                  <div class="meta"><span>15 Dec 2024</span><a href="#">Đọc thêm →</a></div>
                </div>
              </article>
              <article class="post">
                <div class="thumb">
                ...
                <div class="body">
                  <span class="badge new" style="position:static;display:inline-block;margin-bottom:10px">Khám phá</span>
                  <h3 class="h6">Khám phá vùng cà phê Đắk Lắk</h3>
                  <p class="muted">Từ nông trại đến ly cà phê - terroir tạo nên hương vị đặc trưng.</p>
                  <div class="meta"><span>12 Dec 2024</span><a href="#">Đọc thêm →</a></div>
                </div>
              </article>
            </div>
